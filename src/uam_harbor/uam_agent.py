"""
UAM-Integrated Agent for Harbor/Terminal-Bench (v3.0.0)
...
class UAMAgent(ClaudeCode):
    """UAM Agent v2.0.0 - Classified preamble with smart routing."""
    ...
    def create_run_agent_commands(self, instruction: str) -> list[ExecInput]:
        """Override to prepend classified UAM patterns and run pre-execution hooks."""
